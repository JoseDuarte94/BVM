...
if opcion == "Nuevo análisis":
    ...
    # ======================================
    # LISTA DE RIESGOS EN MEMORIA (SESIÓN)
    # ======================================
    ...
    with riesgo_col1:
        ...
        nombre_riesgo = st.text_input(
            "Nombre del riesgo",
            placeholder="Ej. Riesgo cambiario"
        )
    ...
    categoria_riesgo, emoji_riesgo = clasificar_nivel_riesgo(
        nivel_riesgo
    )

    # ======================================
    # DATOS BASE DE LA MATRIZ (CELDAS EN GRIS)
    # ======================================
    ...
    z_valores = [
        [p * i for i in impactos]
        for p in probabilidades
    ]

    z_base = [
        [0 for _ in impactos]
        for _ in probabilidades
    ]

    # ======================================
    # CAPA DE RESALTADO (SOLO CELDA SELECCIONADA)
    # ======================================

    z_resaltado = [
        [None for _ in impactos]
        for _ in probabilidades
    ]
    ...
    # Capa base: todas las celdas en gris, con el número de referencia
    ...
    # Capa superior: solo la celda seleccionada, con su color de riesgo
    figura_riesgo.add_trace(
        go.Heatmap(
            z=z_resaltado,
            x=impactos,
    ...
    st.subheader("🧾 Resumen de la matriz")
    ...
    with resumen_col1:
        ...
        st.metric(
            "Probabilidad",
            etiquetas_probabilidad[probabilidad_riesgo]
        )
    ...
    with resumen_col2:
        ...
        st.metric(
            "Impacto",
            etiquetas_impacto[impacto_riesgo]
        )
    ...
    if st.button("➕ Agregar riesgo a la lista"):
        ...
        if not nombre_riesgo:
            ...
            st.warning(
                "Debe ingresar un nombre para el riesgo antes de agregarlo."
            )
            ...
            st.success(
                f"Riesgo '{nombre_riesgo}' agregado a la lista."
            )
    ...
    if st.session_state.lista_riesgos:
        ...
        for indice, riesgo_item in enumerate(st.session_state.lista_riesgos):
            ...
            tabla_col1, tabla_col2, tabla_col3, tabla_col4, tabla_col5 = st.columns(
                [3, 2, 2, 2, 1]
            )
            ...
            with tabla_col3:
                st.write(
                    f"P: {riesgo_item['probabilidad']} · I: {riesgo_item['impacto']}"
                )
    ...
    leyenda_col1, leyenda_col2, leyenda_col3, leyenda_col4 = st.columns(4)
    ...
    # ======================================
    # RISK SCORE GENERAL (RISK ENGINE)
    # ======================================
